...
describe('TC3_Negative_Login_InvalidPassword',() => {
...
describe('English language', () => {
  ...
  it('Loging in User (Wrong Email password)',() => {
    cy
    ...
    cy 
      .get('@passwordInput')
      .type(fixtureData.invalidPassword)
    ...
    cy
      .get('[class="chakra-alert__title css-tidvy5"]')
      .should('be.visible')  
  })
})
...
describe('Czech language', () => {
  ...
  it('Loging in User (Wrong password)',() => {
    cy
