...
describe('TC2_Positive_Agent_Login_A',() => {
...
describe('English language', () => {
  ...
  it('Loging in Agent (valid email && password)',() => {
    cy
    ...
    cy
      .get('[class="HeaderNav css-1mdbraf"]')
      .should('have.css', 'background-color', `${fixtureData.backgroundColorAgent}`) 
